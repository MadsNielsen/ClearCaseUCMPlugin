...
import org.jenkinsci.plugins.externaldata.ExternalDataProvider.NoSQLDescriptor;
...
public class BaselinesFound extends BaseTestClass {
    ...
    public void newBaselinesFoundTestedInDatabase() throws Exception {    
        jenkins.getInstance().getDescriptorByType(ExternalDataPlugin.class).setProvider(impl);
